...
public class BorradoCuidado extends DialogFragment implements View.OnClickListener {
    ...
    Toast toast;
    public BorradoCuidado(Cuidado cuidado) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.dialog_borrado_cuidado, null);
        context = v.getContext();
        textViewMensajeConfirmacion = v.findViewById(R.id.textViewConfirmacionBorradoCuidado);
        textViewMensajeConfirmacion.setText(textViewMensajeConfirmacion.getText().toString() + "Cuidado nº " + cuidado.getIdCuidado());
        btnSi = v.findViewById(R.id.btnSiBorradoCuidado);
        btnSi.setOnClickListener(this);
        btnNo = v.findViewById(R.id.btnNoBorradoCuidado);
    ...
    public void onClick(View v) {
        if (v.getId() == btnNo.getId()) {
            ...
            BDConexion.borrarCuidado(cuidado, new Callback() {
                @Override
    ...
    private void sendResult(boolean success) {
        ...
        if (isAdded()) {
            Log.d("BorradoCuidado", "Fragment is added, sending result: " + success);
            getParentFragmentManager().setFragmentResult("borradoCuidadoRequestKey", result);
        } else {
            Log.d("BorradoCuidado", "Fragment not added, result not sent");
        }
    }
}